	...
	print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<section id="footer">
						<div class="container">
							<ul class="copyright">
								<li>&copy; 2017 JB Tree Surgery and Property Management. All rights reserved.</li><li>Design: <a href="https://dsabia.github.io">dsabia</a><br/>Template: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</section>
